...
class Interferometer:
    ...
    def draw(self, show_params=True, show_plot=True):
        """Use matplotlib to make a drawing of the interferometer
        Args:
            show_params (bool): whether to show parameters on generated plot
        ...
        for BS in self.BS_list:
            ...
            plt.plot((x + 0.4, x + 0.9), (N - (BS.mode2 + BS.mode1) / 2, N - (BS.mode2 + BS.mode1) / 2), lw=1,
                     color="blue")
            ...
            plt.plot((x + 0.15, x + 0.15), (N + 0.3 - (BS.mode2 + BS.mode1) / 2., N + 0.7 - (BS.mode2 + BS.mode1) / 2.),
                     lw=1, color="blue")
