...
Ms = np.arange(9,21)
sq_dis_ratio = 1
alpha = 0.01  # the alpha in anti-concentration
repeat = 1000
...
for iter, M in enumerate(Ms):
    ...
    logging.info('')
    logging.info(f'For M={M}, mean photon N={N}, N of interest = {N_int}, sq/dis ratio = {sq_dis_ratio}, num_prob={num_prob}')

    dir2 = dir + fr'\M={M}_N={N_int}'
